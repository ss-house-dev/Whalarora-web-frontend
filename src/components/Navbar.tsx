    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 bg-[#16171D] h-14 flex items-center px-4 md:px-6 py-3 w-full z-[70]">
          ...
          {session ? (
            <div className="flex items-center gap-3">
              ...
              <div className="relative" ref={mobileUserMenuRef}>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-[160px] bg-[#1F4293] rounded-lg shadow-lg overflow-hidden z-[99999]">
                    <button
                      type="button"
            ...
            // ยังไม่ล็อกอิน (mobile): ไม่แสดงปุ่มใด ๆ ทางขวา ตามรูปที่ 1
            <div />
          )}
        </div>
        ...
        <div className="hidden md:flex w-full items-center justify-between">
          {/* ซ้าย: โลโก้ไอคอน + โลโก้ตัวหนังสือ */}
