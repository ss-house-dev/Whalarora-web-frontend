...
interface NavbarUIProps {
  ...
  mobileBalanceMenuRef: React.RefObject<HTMLDivElement | null>;
  desktopBalanceMenuRef: React.RefObject<HTMLDivElement | null>;
          ...
          <div className="flex items-center gap-4">
            ...
            {session ? (
              ...
              <button
                ...
                className="text-white text-sm px-4 py-2 rounded-lg bg-[#225FED] transition-all duration-300 cursor-pointer"
              >
                Log in
              </button>
            )}
