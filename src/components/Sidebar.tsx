...
export default function Sidebar() {
  return (
    <div className="w-[84px] min-h-screen bg-[#16171D] fixed top-10 left-0 z-40">
      <div className="p-4 mt-[32px] text-white text-sm text-center space-y-[16px]">
        {/* Expand/Shrink Icon with extended hover effect */}
        <div className="group cursor-pointer">
          <Tooltip>
            <TooltipTrigger className="flex items-center">
              <div className="w-full mx-1 p-[16px] pr-[28px] rounded-l-[12px] group-hover:bg-black/12 transition-colors duration-200">
                <svg
                  width="22"
                  height="22"
                  viewBox="0 0 22 22"
                ...
                >
                  <path
                    ...
                    fill="currentColor"
                    className="text-white group-hover:text-[#225FED] transition-colors duration-200"
                  />
                  <path
        ...
        {/* My Asset Icon */}
        <div className="group cursor-pointer -mr-4">
          <Tooltip>
            <TooltipTrigger className="flex items-center">
              <div className="w-full mx-1 p-[16px] pr-[28px] rounded-l-[12px] group-hover:bg-black/12 transition-colors duration-200">
                <svg
