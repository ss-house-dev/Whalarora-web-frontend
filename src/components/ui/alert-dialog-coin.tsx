...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        'text-center text-[#FFB514] text-sm font-["Alexandria"] font-medium leading-tight',
        className
      )}
      {...props}
    />
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        'mx-auto w-64 text-center text-[#FFFFFF] text-sm font-["Alexandria"] font-normal leading-tight',
        className
      )}
      {...props}
    />
...
function AlertDialogSubtext({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      data-slot="alert-dialog-subtext"
      className={cn(
        'mx-auto w-56 text-center text-[#A4A4A4] text-sm font-["Alexandria"] font-normal leading-tight',
        className
      )}
      {...props}
    />
