...
import getCashBalance, { CashBalance } from '@/features/wallet/services/getCash';

export const useGetCashBalance = <TData = CashBalance>(
  options?: Partial<UseQueryOptions<CashBalance, Error, TData, [TradeQueryKeys.GET_CASH_BALANCE]>>
) => {
  return useQuery({
