...
export default function MarketOrderContainer() {
  ...
  // focus/blur handlers สำหรับ Price input
  const handleFocus = () => {
        ...
        <Tabs defaultValue="buy">
                  ...
                  <div className="bg-[#212121] w-full rounded-lg flex items-center justify-between pl-[90px] pr-4 py-3 h-[32px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
                    ...
                    <div className="flex gap-2 items-center">
                      <input
                        ...
                        readOnly
                      />
                      <span className="text-[16px] font-normal text-[#92CAFE]">USD</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-[#17306B] w-full rounded-lg flex items-center justify-between pl-[90px] pr-4 py-3 h-[32px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
                    ...
                    <div className="flex gap-2 items-center">
                      <input
                        ...
                        readOnly
                      />
                      <span className="text-[16px] font-normal text-[#92CAFE]">BTC</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="sell" className="mt-7">
            <div className="space-y-7">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 text-[16px]">
                      ...
                      <span
                        className={`text-[14px] font-normal ${
                          sellAmount || isSellAmountFocused ? "text-white" : "text-[#5775B7]"
                        }`}
                      >
                        BTC
                      </span>
              ...
              {/* Slider */}
              <div className="mx-3">
                <DiscreteSlider value={sellSliderValue} onChange={handleSellSliderChange} />
              </div>
